...
CONST int MaximumClustersToTransfer = 32;
...
DEFINE_CONSTRUCTOR( NTFS_ATTRIBUTE, OBJECT   );
...
--*/
{
    CONST  int MaxBytesPerMappingPair = sizeof(LCN) + sizeof(VCN) + 1;
...
--*/
{
    CONST  int MaxNumBytesToCheck = 65536;
    ULONG    chomp_length, bytes_read, disk_bytes;
    PUCHAR  buf;
    ULONG   i, j;
    BOOLEAN error;
